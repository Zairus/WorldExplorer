...
public class WEConstants
{
	...
	public static final String CORE_VERSION = "1.0.13 Dev";
	...
	public static final String ARCHERY_VERSION = "1.0.10 Dev";
	...
	public static final String EQUIPMENT_VERSION = "1.0.6 Dev";

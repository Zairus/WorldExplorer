	...
	extends Render
{
	...
	public void doRender(EntityWhipTip whip, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_)
	{
        ...
        if (itemstack.getItem() == null)
        {
            ...
            GL11.glRotatef(whip.rotationYaw - 90.0F, 0.0F, 1.0F, 0.0F);
            GL11.glRotatef(whip.rotationPitch + 225.0F, 0.0F, 0.0F, 1.0F);
            
            if (renderEWhip(whip, itemstack, f2, f3, random, renderManager.renderEngine, field_147909_c, b0))
            {
            	;
            }
	...
	public void drawTexturedModalRect(float posX, float posY, float posZ, int textureX, int textureY, int textureW, int textureH)
    {
        ...
        float f = 0.05F;
        float f1 = 0.05F;
        float z1 = posZ; //0.0625F;
        
        tessellator.startDrawingQuads();
        
        tessellator.addVertexWithUV((double)(posX + 0), (double)(posY + textureH), (double)z1, (double)((float)(textureX + 0) * f), (double)((float)(textureY + textureH) * f1));
        tessellator.addVertexWithUV((double)(posX + textureW), (double)(posY + textureH), (double)z1, (double)((float)(textureX + textureW) * f), (double)((float)(textureY + textureH) * f1));
        tessellator.addVertexWithUV((double)(posX + textureW), (double)(posY + 0), (double)z1, (double)((float)(textureX + textureW) * f), (double)((float)(textureY + 0) * f1));
        tessellator.addVertexWithUV((double)(posX + 0), (double)(posY + 0), (double)z1, (double)((float)(textureX + 0) * f), (double)((float)(textureY + 0) * f1));
	...
	{
		doRender((EntityWhipTip)entity, p_76986_2_, p_76986_4_, p_76986_6_, p_76986_8_, p_76986_9_);
	}
	
	protected ResourceLocation getEntityTexture(EntityWhipTip Whip)
	{
	...
	private void renderDroppedItem(EntityWhipTip Whip, IIcon icon, int renderPass, float angle, float colorRed, float colorGreen, float colorBlue)
    {
        this.renderDroppedItem(Whip, icon, renderPass, angle, colorRed, colorGreen, colorBlue, 0);
    }
	
	private void renderDroppedItem(EntityWhipTip Whip, IIcon icon, int renderPasses, float angle, float colorRed, float colorGreen, float colorBlue, int pass)
	{
